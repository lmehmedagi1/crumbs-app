...
public class DietRequest {
    ...
    @Pattern(regexp = "^[a-zA-Z0-9ščćđžČŠĆĐŽ_\\s\\\\.,\\-!?%]*$", flags = Pattern.Flag.UNICODE_CASE, message = "Diet title can only contain letters, numbers " +
            "and special characters: _ \\ . , - ! ? %")
    private String title;

    @NotBlank
    @Size(max = 2000, message = "Diet description exceeds allowed limit of 2000 characters!")
    @Pattern(regexp = "^[a-zA-Z0-9ščćđžČŠĆĐŽ_\\s\\\\.,\\-!?%]*$", flags = Pattern.Flag.UNICODE_CASE, message = "Diet description can only contain letters, numbers " +
            "and special characters: _ \\ . , - ! ? %")
